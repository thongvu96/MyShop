...
<div class="x_content">
	...
	<form:form id="demo-form" modelAttribute="categoryVO"
		action="${pageContext.request.contextPath}/admin/category/deleteCategory"
		...
		<br />
		<%-- <label for="fullname">Target Customer * :</label>
		<form:input type="text" id="fullname" path="tcName" class="form-control" name="fullname"
			required="required" readonly="true"/>
		<br> --%>
